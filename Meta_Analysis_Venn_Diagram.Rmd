...
```{r}
cairo_ps("Biomarker_Venn.eps", width = 15, height = 12)
biomarkers <- list(Ab_deposition, IL_1B, Microglia, GFAP)
ggVennDiagram(biomarkers, category.names = c("Abeta", "IL-1B", "Iba-1", "GFAP")) +
...
```{r}
cairo_ps("Behavioral_Venn.eps", width = 15, height = 12)
