...
```{r}
postscript("IL_1B_forest_plot_output.eps", width = 15, height = 15, horizontal = FALSE, onefile = FALSE, paper = "special")
...
```{r}
postscript("Outlier_IL_1B.eps", width = 15, height = 10, horizontal = FALSE, onefile = FALSE, paper = "special")
find.outliers(meta_analysis_IL_1B)
```

```{r}
meta_analysis_IL_1B.inf <- InfluenceAnalysis(meta_analysis_IL_1B, random = TRUE)

plot(meta_analysis_IL_1B.inf, "baujat")
plot(meta_analysis_IL_1B.inf, "es")
plot(meta_analysis_IL_1B.inf, "i2")
```
...
postscript("IL_1B_network_forest_output.eps", width = 15, height = 15, horizontal = FALSE, onefile = FALSE, paper = "special")
...
```{r}
cairo_ps("IL_1B_network_plot.eps")
