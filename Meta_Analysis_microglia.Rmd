...
```{r}
postscript("microglia_forest_plot_output.eps", width = 15, height = 15, horizontal = FALSE, onefile = FALSE, paper = "special")
...
```{r}
find.outliers(meta_analysis_microglia)
```

```{r}
postscript("Leave_Microrglia.eps", width = 15, height = 15, horizontal = FALSE, onefile = FALSE, paper = "special")
meta_analysis_microglia.inf <- InfluenceAnalysis(meta_analysis_microglia, random = TRUE)
#plot(meta_analysis_microglia.inf, "baujat")
plot(meta_analysis_microglia.inf, "es")
#plot(meta_analysis_microglia.inf, "i2")
dev.off()
```
...
postscript("Microrglia_network_forest_output.eps", width = 15, height = 15, horizontal = FALSE, onefile = FALSE, paper = "special")
...
```{r}
cairo_ps("microglia_network_plot.eps")
