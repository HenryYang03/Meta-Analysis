...
```{r}
postscript("Escape_latency_day1_forest.eps", width = 15, height = 10, horizontal = FALSE, onefile = FALSE, paper = "special")
...
```{r}
postscript("Escape_latency_day2_forest.eps", width = 15, height = 10, horizontal = FALSE, onefile = FALSE, paper = "special")
...
```{r}
postscript("Escape_latency_day3_forest.eps", width = 15, height = 10, horizontal = FALSE, onefile = FALSE, paper = "special")
...
```{r}
postscript("Escape_latency_day4_forest.eps", width = 15, height = 10, horizontal = FALSE, onefile = FALSE, paper = "special")
...
```{r}
find.outliers(meta_analysis_escape_latency_day4)
```

```{r}
meta_analysis_escape_latency_day4.inf <- InfluenceAnalysis(meta_analysis_escape_latency_day4, random = TRUE)

plot(meta_analysis_escape_latency_day4.inf, "baujat")
plot(meta_analysis_escape_latency_day4.inf, "es")
plot(meta_analysis_escape_latency_day4.inf, "i2")
```
...
```{r}
postscript("Escape_latency_day5_forest.eps", width = 15, height = 10, horizontal = FALSE, onefile = FALSE, paper = "special")
...
```{r}
postscript("Escape_latency_line_plot.eps", width = 15, height = 10, horizontal = FALSE, onefile = FALSE, paper = "special")
...
postscript("escape_latency_day4_network_forest_output.eps", width = 15, height = 15, horizontal = FALSE, onefile = FALSE, paper = "special")
...
```{r}
cairo_ps("escape_latency_day4_network_plot.eps")
